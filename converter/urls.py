...
urlpatterns = [
    ...
    path('download/nquads/', views.download_nquads, name='download_nquads'),
    ...
    path('matches/', views.header_matches, name='header_matches'),
    path('vocab_ranking/', views.vocab_ranking, name='vocab_ranking'),
